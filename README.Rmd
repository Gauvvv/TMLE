...
# Load required package (optional but recommended for styling)
...
summary_table <- data.frame(
  ...
  `% Bias` = 100 * (estimates - true_ATE) / true_ATE
)

# Render table
knitr::kable(summary_table, digits = c(NA, 3, 3, 3, 3, 2, 1),
             caption = "Estimated ATEs with SEs, 95% CIs, Bias and Percent Bias") %>%
